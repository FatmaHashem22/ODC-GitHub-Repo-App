...
import com.example.odcgithubrepoapp.presentation.utils.Constants.Companion.ISSUES_SCREEN
...
sealed class Screens(val route: String) {
    ...
    data object IssuesScreen : Screens("$ISSUES_SCREEN/{$OWNER_ARGUMENT_KEY}/{$NAME_ARGUMENT_KEY}") {
        fun passOwnerAndName(owner: String, name:String) : String {
